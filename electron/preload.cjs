...
contextBridge.exposeInMainWorld('electron', {
  ...
  invoke: (channel, ...args) => {
    ...
    const validChannels = [
      ...
      'delete-mod',
      'delete-shader',
      'delete-resourcepack',      'update-mod',
      'update-config',
      'search-mods',
      'search-shaders',
  ...
  'browser-panel:status',
      ...
      'minecraft-load-auth',
      'minecraft-save-auth',
      'minecraft-list-reusable-auth',
      'minecraft-import-auth-from-instance',
  ...
  'toggle-client-asset',   'delete-client-asset',
